...
consumer = KafkaConsumer('test',bootstrap_servers=[' my-kafka-0.my-kafka-headless.yarelib07.svc.cluster.local:9092'])#'my-kafka-0.my-kafka-headless.kafka-adsoftsito.svc.cluster.local:9092'])

...
uri = "mongodb+srv://yareli:yare1@nosql.3mfx8ew.mongodb.net/?retryWrites=true&w=majority"
...
consumer = KafkaConsumer('reactions',bootstrap_servers=[' my-kafka-0.my-kafka-headless.yarelib07.svc.cluster.local:9092'])#'my-kafka-0.my-kafka-headless.kafka-adsoftsito.svc.cluster.local:9092'])
